...
def clean_json_data():
    ...
    pickle.dump(json_f, open('C:/Users/Super_Computer/ProjectIR-backend/resources/anime_data.pkl', 'wb'))
    pickle.dump(json_f['title'], open('C:/Users/Super_Computer/ProjectIR-backend/resources/spell_corr_title.pkl', 'wb'))
    pickle.dump(json_f['synopsis'], open('C:/Users/Super_Computer/ProjectIR-backend/resources/spell_corr_synopsis.pkl', 'wb'))
